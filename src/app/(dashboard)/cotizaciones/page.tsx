...
export default function CotizacionesPage() {
  ...
  return (
    <div>
      ...
      {filtered.length === 0 ? (
        <div className="text-center py-12"><FileText className="w-12 h-12 text-cva-gray-300 mx-auto mb-4" /><p className="text-cva-gray-500">No hay cotizaciones</p><Link href="/cotizaciones/nueva"><Button variant="outline" className="mt-4">Crear primera cotización</Button></Link></div>
      ) : (
